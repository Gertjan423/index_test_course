...
--- type:VideoExercise lang:python xp: skills: key:f64d254a4a
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:c8334b8dd5
...
--- type:NormalExercise lang:python xp: skills: key:72b5b52458
## Our data 
...
--- type:VideoExercise lang:python xp: skills: key:8b464dcf7a
## Keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:2cef894106
## Primary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:5c5f6e497e
## Secondary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:360e2ec51f
## Multi-variable keys 
...
--- type:VideoExercise lang:python xp: skills: key:344f77184f
## Joins 
Demonstrate left_join() and right_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:93cb820219
## A basic join 
...
--- type:NormalExercise lang:python xp: skills: key:abc97416b0
## A right join 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:0b5812ab65
## Right vs. left 
...
--- type:VideoExercise lang:python xp: skills: key:9455895a5c
## Variations on joins 
Explain diagram syntax. Demonstrate the differences between left_join(), right_join(), inner_join(), and full_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:be996160c4
## Inner joins 
...
--- type:NormalExercise lang:python xp: skills: key:bfb1d70989
## Full joins 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:63f450ca57
## Choose a join 
...
--- type:NormalExercise lang:python xp: skills: key:ab59cdbe53
## Use a join 
