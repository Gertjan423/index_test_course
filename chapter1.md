...
--- type:VideoExercise lang:python xp: skills: key:70ae1fccc2
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:dded87b216
...
--- type:NormalExercise lang:python xp: skills: key:8b468cfdcd
## Our data 
...
--- type:VideoExercise lang:python xp: skills: key:977db213e5
## Keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:646ff5218c
## Primary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:00628d388b
## Secondary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:37fecd351a
## Multi-variable keys 
...
--- type:VideoExercise lang:python xp: skills: key:207ec68e1b
## Joins 
Demonstrate left_join() and right_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:ac53f7cce3
## A basic join 
...
--- type:NormalExercise lang:python xp: skills: key:76263da531
## A right join 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:0ad71b0a4b
## Right vs. left 
...
--- type:VideoExercise lang:python xp: skills: key:6005acf0f1
## Variations on joins 
Explain diagram syntax. Demonstrate the differences between left_join(), right_join(), inner_join(), and full_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:15c7f98eca
## Inner joins 
...
--- type:NormalExercise lang:python xp: skills: key:549c869172
## Full joins 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:07aa418962
## Choose a join 
...
--- type:NormalExercise lang:python xp: skills: key:69adcd44cc
## Use a join 
