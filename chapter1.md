...
--- type:VideoExercise lang:python xp: skills: key:3df886eafc
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:f744e62eb9
...
--- type:NormalExercise lang:python xp: skills: key:b4b82233ac
## Our data 
...
--- type:VideoExercise lang:python xp: skills: key:c56af8750a
## Keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:64518cab1a
## Primary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:2cf9bd0c67
## Secondary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:9eaa93f06b
## Multi-variable keys 
...
--- type:VideoExercise lang:python xp: skills: key:278eda0b7a
## Joins 
Demonstrate left_join() and right_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:7539091eb9
## A basic join 
...
--- type:NormalExercise lang:python xp: skills: key:9cc4208a99
## A right join 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:b2bbe4dd7a
## Right vs. left 
...
--- type:VideoExercise lang:python xp: skills: key:14262a08c5
## Variations on joins 
Explain diagram syntax. Demonstrate the differences between left_join(), right_join(), inner_join(), and full_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:48bb6b1486
## Inner joins 
...
--- type:NormalExercise lang:python xp: skills: key:922f4698f4
## Full joins 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:e8ac359230
## Choose a join 
...
--- type:NormalExercise lang:python xp: skills: key:a4499c2a59
## Use a join 
