...
--- type:VideoExercise lang:python xp: skills: key:dbb718a1f7
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:4cecbace63
...
--- type:NormalExercise lang:python xp: skills: key:3e52599c11
## Our data 
...
--- type:VideoExercise lang:python xp: skills: key:9a3c0353f6
## Keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:ade43577b0
## Primary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:adc58e6dfa
## Secondary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:d3a2891aea
## Multi-variable keys 
...
--- type:VideoExercise lang:python xp: skills: key:b4af42affd
## Joins 
Demonstrate left_join() and right_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:67738d0872
## A basic join 
...
--- type:NormalExercise lang:python xp: skills: key:242cea490e
## A right join 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:7c04a6f9db
## Right vs. left 
...
--- type:VideoExercise lang:python xp: skills: key:cc6a667c25
## Variations on joins 
Explain diagram syntax. Demonstrate the differences between left_join(), right_join(), inner_join(), and full_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:749dbedc94
## Inner joins 
...
--- type:NormalExercise lang:python xp: skills: key:22e44ae183
## Full joins 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:d5f1997128
## Choose a join 
...
--- type:NormalExercise lang:python xp: skills: key:33674b0e8e
## Use a join 
