...
--- type:MultipleChoiceExercise lang:python xp: skills: key:9fc17369f8
...
--- type:NormalExercise lang:python xp: skills: key:42ef640aa7
## Our data 
...
--- type:VideoExercise lang:python xp: skills: key:d79ae9fbef
## Keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:5747ac1025
## Primary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:f2cb5fe088
## Secondary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:0380770188
## Multi-variable keys 
...
--- type:VideoExercise lang:python xp: skills: key:cb703c3641
## Joins 
Demonstrate left_join() and right_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:753f9b5a37
## A basic join 
...
--- type:NormalExercise lang:python xp: skills: key:84750e80cc
## A right join 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:94900bcf05
## Right vs. left 
...
--- type:VideoExercise lang:python xp: skills: key:f339084e29
## Variations on joins 
Explain diagram syntax. Demonstrate the differences between left_join(), right_join(), inner_join(), and full_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:6459921ecf
## Inner joins 
...
--- type:NormalExercise lang:python xp: skills: key:a5ae6e1af1
## Full joins 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:8bc1ded515
## Choose a join 
...
--- type:NormalExercise lang:python xp: skills: key:bfac94cbd1
## Use a join 
