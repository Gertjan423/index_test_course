...
--- type:VideoExercise lang:python xp: skills: key:3266bf0664
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:a1b3ade8cf
...
--- type:NormalExercise lang:python xp: skills: key:2bc9e840ef
## Our data 
...
--- type:VideoExercise lang:python xp: skills: key:946b52b94d
## Keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:efd582b5fb
## Primary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:ca5622234f
## Secondary keys 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:4ea0211ad6
## Multi-variable keys 
...
--- type:VideoExercise lang:python xp: skills: key:e7d6e4d39e
## Joins 
Demonstrate left_join() and right_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:9b604eccda
## A basic join 
...
--- type:NormalExercise lang:python xp: skills: key:9b39e67585
## A right join 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:da4fcd0450
## Right vs. left 
...
--- type:VideoExercise lang:python xp: skills: key:3654c27bbe
## Variations on joins 
Explain diagram syntax. Demonstrate the differences between left_join(), right_join(), inner_join(), and full_join().

*** =video_link

--- type:NormalExercise lang:python xp: skills: key:bdc7353002
## Inner joins 
...
--- type:NormalExercise lang:python xp: skills: key:4630d81b36
## Full joins 
...
--- type:MultipleChoiceExercise lang:python xp: skills: key:1bda4694dd
## Choose a join 
...
--- type:NormalExercise lang:python xp: skills: key:4322a065ff
## Use a join 
